...
#         'DRIVER={ODBC Driver 13 for SQL Server};SERVER=' + server + ';DATABASE=' + database + ';UID=' + username + ';PWD=' + password + ';MARS_Connection=Yes')
#
#
# conexao = Conexao()
...
# class SpiderTelelistaDb(scrapy.Spider):
#     try:
#         name = "telelistadb"
#
#         def __init__(self, url='', *args, **kwargs):
#             super(SpiderTelelistaDb, self).__init__(*args, **kwargs)
#
...
#                     telefones = response.xpath(
#                         '//td[@class="text_resultado_ib" and (contains(text(),"Tel") or contains(text(),"PABX") or contains(text(),"Cel") or contains(text(),"Fax"))]/text()').extract()
...
#                             y = 0
#                             for nome in nomes:
#                                 id_cliente = gravar_cliente(uf_busca, cidade_busca, nome,
#                                                             enderecos[y] + " " + enderecos[y + 1],
#                                                             self.id_ramo_atividade)
...
#            "'" + uf_busca + "','" + cidade_busca + "','" + nome_cliente + "','" + endereco + "'," + str(
#                 ramo_atividade) + ")")
#
